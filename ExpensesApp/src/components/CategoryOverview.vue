<script lang="ts" setup>
	...
	const getExpensesByCategoryId = async (categoryName: string, categoryId: string) => {
...
<template>
	<div class="masonry">
		<div class="column masonry-container">
			...
			<div v-for="category in categories" :key="category.id" class="masonry-cell" tabindex="0">
				<q-card
