<template>
	<v-card class="mx-auto" width="600">
		...
		<v-card-text>
			<p>
				Via this interface, you can create and edit quizzes. This panel is not perfect, but it
				works. As an extra challenge consider implementing the following features:
			</p>
			<ul class="ma-4">
				<li>
